...
import { tooltip } from 'artplayer/src/utils';
import { Episodes } from './Episodes'; // Adjusted import statement
import './Episodes.css'; // Assuming you want to style the Episodes component
...
export default function ArtPlayer1({ option, getInstance, onInstanceChange, additionalSettings,totalEpisodes, ...rest }) {
  const artRef = useRef();
  ...
  }, [option.url, totalEpisodes]); // Include option.url in the dependency array
